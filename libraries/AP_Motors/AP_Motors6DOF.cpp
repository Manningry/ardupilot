...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case SUB_FRAME_CUSTOM:
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_5,     0.25f,          0,              0,               0,                 0,                 -1.0f,           5);
        add_motor_raw_6dof(AP_MOTORS_MOT_6,    -0.25f,          0,              0,               0,                 0,                  1.0f,           6);
        add_motor_raw_6dof(AP_MOTORS_MOT_7,     0,            1.0f,             0,              0.5f,               0,                  1.0f,           7);
        add_motor_raw_6dof(AP_MOTORS_MOT_8,     0,            1.0f,             0,             -0.5f,               0,                  -1.0f,          8);
        break;
